    ...
    <section class="container mx-auto px-6 py-12 md:py-16">
        <?php if(empty($budaya)): ?>
            <div class="text-center py-20 md:py-32 border-4 border-dashed border-slate-50">
                <p class="text-slate-300 font-black uppercase tracking-[0.3em] md:tracking-[0.5em] text-xs md:text-sm italic">Data tidak ditemukan</p>
                    ...
                    <article class="group flex flex-col h-full">
                        ...
                        <div class="space-y-3 md:space-y-4 flex flex-col flex-grow">
                            <div class="flex items-center gap-2">
                                <span class="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-amber-600"><?= $b['nama_provinsi'] ?></span>
                            ...
                            <div class="pt-4 border-t border-slate-50">
                                <a href="budaya_detail.php?id=<?= $b['id'] ?>" class="inline-block text-[9px] md:text-[10px] font-black uppercase tracking-widest text-slate-900 border-b-2 border-red-700 pb-1 hover:text-red-700 transition">
                                    Baca Narasi →
                                </a>
                            </div>
                        </div>
